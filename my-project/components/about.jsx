export default function About() {
  return (
    <div id="about" className="flex flex-col mt-16 ">
      <h1 className="mx-auto font-extrabold text-3xl">About</h1>
      ...
      <p className=" mx-[10%] sm:text-base  font-serif mt-3 text-justify  lg:text-xl xl:text-2xl">
        My name is <span className=" font-extrabold border-b-cyan-400 border-b"> Ahmad Hawchar </span>. I am a student at CNAM university and an
